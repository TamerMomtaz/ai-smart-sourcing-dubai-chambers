...
class EvaluationResponse(BaseModel):
    ...
    novelty_score: Optional[float] = Field(None, description="Innovation novelty score")
...
class EvaluationDetail(BaseModel):
    ...
    novelty_score: Optional[float] = Field(None, description="Innovation novelty score")
    novelty_reasoning: Optional[str] = Field(None, description="Innovation novelty reasoning")
    composite_score: float = Field(..., description="Composite score")
    evaluated_at: datetime = Field(..., description="Evaluation timestamp")
