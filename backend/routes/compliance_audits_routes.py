...
async def export_compliance_audits(
    ...
    try:
        ...
        csv_writer.writerow([
            ...
            "Audit Type",
            "Audit Timestamp",
            "DESC ISR V3 Controls Compliance",
            "DESC AI Security Policy (5-Phase Lifecycle) Compliance",
            "DESC CSP Standards (ISO/IEC 27001, ISO/IEC 27017, CSA CCM v4.0.5) Compliance",
