  ...
  return (
    <div className="min-h-screen bg-cream py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-heading font-bold text-ink mb-2">Settings</h1>
          <p className="text-ink/60 font-body">Manage your account preferences and notification settings</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <h2 className="text-2xl font-heading font-bold text-ink mb-4">Account Information</h2>
          <div className="space-y-3">
            <div>
              <label className="block text-sm font-body font-medium text-ink/60 mb-1">Email</label>
              <p className="font-body text-ink">{user?.email}</p>
            </div>
            <div>
              <label className="block text-sm font-body font-medium text-ink/60 mb-1">Role</label>
              <p className="font-body text-ink capitalize">{user?.role?.replace('_', ' ')}</p>
            </div>
            <div>
              <label className="block text-sm font-body font-medium text-ink/60 mb-1">Chamber</label>
              <p className="font-body text-ink">{user?.chamber || 'N/A'}</p>
            </div>
            {user?.business_group && (
              <div>
                <label className="block text-sm font-body font-medium text-ink/60 mb-1">Business Group</label>
        ...
        {/* Profile Settings */}
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <h2 className="text-2xl font-heading font-bold text-ink mb-4">Profile Settings</h2>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <h2 className="text-2xl font-heading font-bold text-ink mb-4">Notification Preferences</h2>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h2 className="text-2xl font-heading font-bold text-ink mb-4">Security</h2>
          <div className="space-y-4">
            <div>
